...
const scl=s=>s==="Готово"||s==="Запланировано"||s==="Опубликовано"?"done":s==="На проверке"?"review":s==="Ошибка"?"error":s==="Ждёт пополнения"?"review":s==="В работе"?"work":"wait";
